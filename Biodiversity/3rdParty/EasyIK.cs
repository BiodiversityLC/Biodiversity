...
// Taken from https://github.com/joaen/EasyIK. Please check this out this is very helpful.
...
public class EasyIK : MonoBehaviour
{
    ...
    private void SolveIK()
    {
        ...
        for (int i = 0; i < jointPositions.Length - 1; i += 1)
        {
            ...
            // below is modified because original doesn't take into consideration parent rotation
            jointTransforms[i].rotation = targetRotation * startRotation[i] * anotherObject.transform.rotation;
        }
