...
public class BiodiversityPlugin : BaseUnityPlugin {
    ...
    private void Awake() {
        ...
        Enemies.RegisterEnemy(BiodiverseAssets.Vermin, Enemies.SpawnType.Daytime, new Dictionary<LevelTypes, int> { { LevelTypes.All, 0} }, null, BiodiverseAssets.VerminNode, BiodiverseAssets.VerminKeyword);
