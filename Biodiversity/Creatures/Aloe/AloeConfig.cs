...
public class AloeConfig(ConfigFile cfg) : BiodiverseConfigLoader<AloeConfig>(cfg)
{
    ...
    public string Rarity { get; private set; } = "Experimentation:28,Assurance:75,Offense:65,March:55,Artifice:95,Hydro:20,Integrity:11,Vertigo:36,Sierra:40,Fray:30,Arelion:7,Seichi:14,Etern:12,Polarus:13,Gloom:5,Fission-C:5,Aquatis:18,Phuket:20,Torus:26,Starship-13:35,Solarius:10,Phaedra:50,Pelagia:18,Arcadia:10,Derelect:30";
