...
namespace Biodiversity.Creatures.CoilCrab
{
    internal class CoilCrabConfig(ConfigFile configFile) : BiodiverseConfigLoader<CoilCrabConfig>(configFile)
    {
        ...
        public string CoilCrabRarityStormy { get; private set; } = "Offense:75,Rend:10,Titan:25,Artifice:35,Asteroid-13:15,Junic:29,Atlantica:15,Gratar:53,Fission:28,Oldred:37,Prominence:20,Seichi:8,Torus:72,Tundaria:39,Starship-13:22,Demetrica:10,Collateral:40,Humidity:21,Brutality:40,Devastation:75,Vaporization:30,Burrow:50,Anchorage:15,,Pelagia:30";

        [field: Tooltip("Spawn weight of the Coil Crab on all moons when it is not stormy.")]
        public string CoilCrabRarity { get; private set; } = "Offense:35,Rend:8,Titan:0,Artifice:12,Asteroid-13:9,Junic:18,Atlantica:2,Gratar:8,Fission:20,Oldred:20,Prominence:10,Seichi:4,Torus:38,Tundaria:19,Starship-13:22,Demetrica:10,Collateral:8,Humidity:0,Brutality:20,Devastation:25,Vaporization:12,Burrow:20,Anchorage:5,Pelagia:15";
