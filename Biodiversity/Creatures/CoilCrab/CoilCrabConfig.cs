...
namespace Biodiversity.Creatures.CoilCrab
{
    internal class CoilCrabConfig(ConfigFile configFile) : BiodiverseConfigLoader<CoilCrabConfig>(configFile)
    {
        ...
        public string CoilCrabRarityStormy { get; private set; } = "Offense:75,Rend:50,Titan:25,Artifice:35,Asteroid-13:15,Junic:29,Atlantica:15,Gratar:53,Fission:28,Oldred:37,Prominence:20,Seichi:8,Torus:72,Tundaria:39,Starship-13:22,Demetrica:10";
