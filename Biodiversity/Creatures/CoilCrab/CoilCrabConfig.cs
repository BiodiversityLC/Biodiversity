...
namespace Biodiversity.Creatures.CoilCrab
{
    internal class CoilCrabConfig(ConfigFile configFile) : BiodiverseConfigLoader<CoilCrabConfig>(configFile)
    {
        ...
        public string CoilCrabRarityStormy { get; private set; } = "Offense:45,Rend:22,Titan:25,Artifice:35,Asteroid-13:15,Junic:29,Atlantica:15,Gloom:5,Gratar:53,Acidir:12,Fission:28,Oldred:37,Fray:1,Prominence:20,Seichi:8,Olympus:10";

        [field: Tooltip("Spawn weight of the Coil Crab on all moons when it is not stormy.")]
        public string CoilCrabRarity { get; private set; } = "Offense:25,Rend:8,Titan:10,Artifice:12,Asteroid-13:9,Junic:18,Atlantica:2,Gloom:4,Gratar:20,Acidir:10,Fission:20,Oldred:20,Fray:1,Prominence:10,Seichi:4,Olympus:7";
