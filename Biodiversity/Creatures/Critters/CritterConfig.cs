...
public class CritterConfig(ConfigFile configFile) : BiodiverseConfigLoader<CritterConfig>(configFile) 
{
	...
	public string LeafBoyRarity { get; private set; } = "Vow:100,Adamance:15,Assurance:85,Offense:5,Artifice:2,Rend:5,Seichi:10,Fray:300,Vertigo:5,Integrity:25,Collateral:10,Hydro:38,Brutality:15,USC Vortex:12,Phaedra:35,Valiance:28,Natit:8,Starship-13:30";
