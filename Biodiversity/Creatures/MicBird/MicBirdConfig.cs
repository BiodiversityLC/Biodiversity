...
namespace Biodiversity.Creatures.MicBird
{
    public class MicBirdConfig(ConfigFile configFile) : BiodiverseConfigLoader<MicBirdConfig>(configFile) {
        ...
        public string BoomBirdRarity { get; private set; } = "Experimentation:22,Adamance:15,Rend:5,Artifice:45,Atlantica:27,Fission-C:24,Gratar:10,Polarus:8,Seichi:8,Arelion:15,Fray:1,Sierra:21,Icebound:12,Humidity:38,Integrity:8,Vertigo:16,Vaporization:20,Timbrance:33,Rorm:25,Starship-13:25,Filitrios:35,Cubatres:10,Dirge:10";
