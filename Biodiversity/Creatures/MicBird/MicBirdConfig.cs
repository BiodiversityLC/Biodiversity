...
namespace Biodiversity.Creatures.MicBird
{
    public class MicBirdConfig(ConfigFile configFile) : BiodiverseConfigLoader<MicBirdConfig>(configFile) {
        ...
        public string BoomBirdRarity { get; private set; } = "Experimentation:15,Rend:32,Titan:15,Artifice:36,Atlantica:27,Etern:18,Fission-C:24,Gratar:10,Polarus:8,Seichi:8,Olympus:4,Arelion:5,Fray:1,Sierra:21";
