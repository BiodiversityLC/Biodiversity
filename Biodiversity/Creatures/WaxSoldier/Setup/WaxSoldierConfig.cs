...
public class WaxSoldierConfig(ConfigFile cfg) : BiodiverseConfigLoader<WaxSoldierConfig>(cfg)
{
    ...
    [field: Range(0.01f, 500f)]
    public float PatrolAcceleration { get; private set; } = 50f;
    ...
    [field: Range(0.01f, 500f)]
    public float PursuitAcceleration { get; private set; } = 50f;
    ...
    [field: Range(0.01f, 500f)]
    public float HuntingAcceleration { get; private set; } = 50f;

    [field: Tooltip("The rotation speed of the Wax Soldier in degrees per second.")]
    [field: Range(0.01f, 999999f)]
    public float AngularSpeed { get; private set; } = 800f;
    #endregion
    ...
    [field: Tooltip("")]
    [field: Range(0, 5000)]
    public int LungeDamage { get; private set; } = 25;
    #endregion
