...
namespace Biodiversity.Items.JunkRadar.Patches
{
    ...
    internal class MaskedMugPatches
    {
        ...
        {
            if (!JunkRadarHandler.Instance.Assets.Loaded || !JunkRadarHandler.Instance.Config.Enabled || MaskedMugItem.enemyToSpawn != null)
            {
                return;
            }
        ...
        {
            if (!JunkRadarHandler.Instance.Assets.Loaded || !JunkRadarHandler.Instance.Config.Enabled || __instance == null || __instance.isPlayerDead)
            {
                return;
            }
        ...
        {
            if (!JunkRadarHandler.Instance.Assets.Loaded || !JunkRadarHandler.Instance.Config.Enabled || __instance == null || !__instance.isPlayerDead || maskedItemToSpawnEnemy == null)
            {
