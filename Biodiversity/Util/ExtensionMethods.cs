...
internal static class ExtensionMethods 
{
    ...
    /// <returns>The value of IsHost property if exists.</returns>
    /// <remarks> Returns false if the property doesn't exist. Uses a null-forgiving operator.</remarks>
    ...
    /// </summary>
    /// <param name="instance">The object instance to inspect.</param>
    /// <returns>The value of IsServer property if exists.</returns>
    /// <remarks> Returns false if the property doesn't exist. Uses a null-forgiving operator.</remarks>
